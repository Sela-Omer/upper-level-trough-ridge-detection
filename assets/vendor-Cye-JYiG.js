import{n as e}from"./rolldown-runtime-CbXtAM7H.js";import{a as t,c as n,i as r,o as i,s as a}from"./vendor-DSeajjiW.js";import{_ as o,a as s,b as c,c as l,d as u,f as d,g as f,h as p,i as m,l as h,m as g,n as _,o as v,p as y,r as b,s as x,t as S,u as C,v as w,y as T}from"./vendor-BoCrZEk0.js";import{A as ee,B as E,C as te,D as ne,E as D,F as O,I as k,L as re,M as ie,N as ae,O as oe,P as se,R as ce,S as le,T as ue,U as de,V as fe,W as pe,_ as me,a as he,b as ge,c as _e,d as ve,f as ye,g as be,h as xe,i as Se,j as A,k as Ce,l as we,m as Te,n as Ee,o as De,p as Oe,r as ke,s as Ae,u as je,v as Me,w as j,x as Ne,y as Pe,z as M}from"./vendor-P2FunmF2.js";import{i as Fe}from"./vendor-CrbJpBxU.js";var N=new pe({id:`deck`}),Ie={};function Le(e){Ie=e}function P(e,t,n,r){N.level>0&&Ie[e]&&Ie[e].call(null,t,n,r)}function Re(e){let t=e[0],n=e[e.length-1];return t===`{`&&n===`}`||t===`[`&&n===`]`}var ze={dataType:null,batchType:null,id:`JSON`,name:`JSON`,module:``,version:``,options:{},extensions:[`json`,`geojson`],mimeTypes:[`application/json`,`application/geo+json`],testText:Re,parseTextSync:JSON.parse};function Be(){let e=`9.3.11`,t=globalThis.deck&&globalThis.deck.VERSION;if(t&&t!==e)throw Error(`deck.gl - multiple versions detected: ${t} vs ${e}`);return t||(N.log(1,`deck.gl ${e}`)(),globalThis.deck={...globalThis.deck,VERSION:e,version:e,log:N,_registerLoggers:Le},c([ze,[w,{imagebitmap:{premultiplyAlpha:`none`}}]])),e}var Ve=Be(),He=`struct LayerUniforms {
  opacity: f32,
};
